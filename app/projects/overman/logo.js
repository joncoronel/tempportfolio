export default function Logo({
  primaryColor = "hsl(var(--nextui-secondary-500))",
  secondaryColor = "hsl(var(--nextui-secondary-400))",
  tertiaryColor = "hsl(var(--nextui-secondary-600))",
  size = "1.75rem",
}) {
  return (
    <svg
